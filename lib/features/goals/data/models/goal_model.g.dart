...
GoalModel _goalModelDeserialize(
  ...
  object.id = id;
  object.isPriority = reader.readBool(offsets[3]);
...
extension GoalModelQueryFilter
  ...
  QueryBuilder<GoalModel, GoalModel, QAfterFilterCondition> isPriorityEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension GoalModelQuerySortBy on QueryBuilder<GoalModel, GoalModel, QSortBy> {
  ...
  QueryBuilder<GoalModel, GoalModel, QAfterSortBy> sortByIsPriority() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPriority', Sort.asc);
    });
  }

  QueryBuilder<GoalModel, GoalModel, QAfterSortBy> sortByIsPriorityDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension GoalModelQuerySortThenBy
  ...
  QueryBuilder<GoalModel, GoalModel, QAfterSortBy> thenByIsPriority() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPriority', Sort.asc);
    });
  }

  QueryBuilder<GoalModel, GoalModel, QAfterSortBy> thenByIsPriorityDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPriority', Sort.desc);
    });
  }
...
extension GoalModelQueryWhereDistinct
  ...
  QueryBuilder<GoalModel, GoalModel, QDistinct> distinctByIsPriority() {
    return QueryBuilder.apply(this, (query) {
...
extension GoalModelQueryProperty
  ...
  QueryBuilder<GoalModel, bool, QQueryOperations> isPriorityProperty() {
    return QueryBuilder.apply(this, (query) {
